execute if score nameplates status matches 0 run scoreboard players set nametags tick 96000
execute if score nameplates status matches 0 run scoreboard players set ShowNametagsAfter setting 80
execute if score nameplates status matches 0 run playsound minecraft:block.note_block.chime master @a ~ ~ ~ 1000000 1 1
execute if score nameplates status matches 0 run tellraw @a ["",{"text":"Show Nametags After:","color":"light_purple"},{"text":" ["},{"text":"80 Minutes","color":"aqua"},{"text":"]"}]
