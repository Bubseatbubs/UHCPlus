...
execute as @a[gamemode=spectator, tag=SSIEGE_dead] if score @s ssiege_death_timer matches 0.. run title @s actionbar [{text:"Currently Spectating "}, {selector:"@p[gamemode=survival]"}]
