...
# Opening Encounter
# TODO: Write functions for the Opening Encounter

# Augments
# TODO: Once opening encounters are implemented, move start/augments function there
function ssiege:start/augments
