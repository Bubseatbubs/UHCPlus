execute if score @s exalted_item_3 matches 0 run return run tellraw @s {"text":"Nether Bricks","color":"yellow"}
execute if score @s exalted_item_3 matches 1 run return run tellraw @s {"text":"Redstone Repeater","color":"yellow"}
execute if score @s exalted_item_3 matches 2 run return run tellraw @s {"text":"Cartography Table","color":"yellow"}
execute if score @s exalted_item_3 matches 3 run return run tellraw @s {"text":"Black Glazed Terracotta","color":"yellow"}
execute if score @s exalted_item_3 matches 4 run return run tellraw @s {"text":"Glowstone","color":"yellow"}
...
execute if score @s exalted_item_3 matches 14 run return run tellraw @s {"text":"Oak Sapling","color":"yellow"}
execute if score @s exalted_item_3 matches 15 run return run tellraw @s {"text":"Bush","color":"yellow"}
execute if score @s exalted_item_3 matches 16 run return run tellraw @s {"text":"Lodestone","color":"yellow"}
execute if score @s exalted_item_3 matches 17 run return run tellraw @s {"text":"Mossy Stone Bricks","color":"yellow"}