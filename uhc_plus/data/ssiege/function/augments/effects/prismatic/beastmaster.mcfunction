...
execute as @e[type=minecraft:wolf,tag=UHCP_New,sort=random,limit=1] run data merge entity @s {Health:40f,equipment:{mainhand:{id:"minecraft:diamond_axe",components:{"minecraft:enchantments":{"minecraft:vanishing_curse":1},"minecraft:enchantment_glint_override":false}},body:{id:"minecraft:wolf_armor",components:{"minecraft:enchantments":{"minecraft:vanishing_curse":1},"minecraft:enchantment_glint_override":false}}},drop_chances:{mainhand:0.000,body:0.000},attributes:[{id:"minecraft:max_health",base:80.0d},{id:"minecraft:scale",base:2.0d},{id:"minecraft:movement_speed",base:0.4d},{id:"minecraft:knockback_resistance",base:0.25d},{id:"minecraft:armor",base:10.0d},{id:"minecraft:armor_toughness",base:1.0d}]}
