...
tellraw @s ["",{"text":"[Adrenal Surge]","bold":true,"color":"aqua"},{"text":" The adrenaline rush","color":"white"},{"text":" gave you","color":"white"},{"text":" 5 seconds of Strength","color":"yellow"},{"text":"!","color":"white"}]