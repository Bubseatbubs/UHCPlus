...
tellraw @s ["",{"text":"[Adrenal Surge]","bold":true,"color":"gold"},{"text":" The adrenaline rush","color":"white"},{"text":" gave you","color":"white"},{"text":" 5 seconds of Resistance","color":"yellow"},{"text":"!","color":"white"}]