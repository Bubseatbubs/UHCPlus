...
execute if score @s uhcp_augment matches 314 run function ssiege:augments/effects/gold/earthbender/init
...
execute if score @s uhcp_augment matches 340 run function ssiege:augments/effects/gold/moonwalking
...
execute if score @s uhcp_augment matches 351 run loot give @s loot uhcp:consumables/relic_invoker
