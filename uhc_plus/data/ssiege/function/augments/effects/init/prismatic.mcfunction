...
execute if score @s uhcp_augment matches 532 run return run give @s netherite_pickaxe[enchantments={"minecraft:efficiency":1,"minecraft:fortune":2}] 1
...
execute if score @s uhcp_augment matches 559 run return run scoreboard players set @s uhcp_game_time 3600
