...
give @s sniffer_spawn_egg[entity_data={id:"minecraft:sniffer",Tags:["babysitting"],attributes:[{id:"minecraft:scale",base:.5}]},custom_name={"color":"gold","text":"Baby Sniffer"}] 2
