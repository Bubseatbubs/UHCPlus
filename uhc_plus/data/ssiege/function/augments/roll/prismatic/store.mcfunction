...
loot replace entity @s container.0 loot ssiege:augments/prismatic
loot replace entity @s container.1 loot ssiege:augments/prismatic
loot replace entity @s container.2 loot ssiege:augments/prismatic

# Roll reroll augments
loot replace entity @s container.4 loot ssiege:augments/prismatic
loot replace entity @s container.5 loot ssiege:augments/prismatic
loot replace entity @s container.6 loot ssiege:augments/prismatic
