...
execute if score %prev_killed uhcp_titans_id matches 1.. run tellraw @a ["",{"text":"Giga Creeper","bold":true,"color":"gold"},{"text":" disappeared..."}]
...
# Spawn Titan
execute in minecraft:overworld positioned 0 300 0 summon minecraft:spider run function ssiege:titans/arachne/init_helper with storage ssiege:titan_health input
