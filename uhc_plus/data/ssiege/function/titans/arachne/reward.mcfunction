...
# Titan's Might buff
execute as @s[team=blue] run scoreboard players add @a[team=blue] ssiege_buff_titanslayer 90
execute as @s[team=red] run scoreboard players add @a[team=red] ssiege_buff_titanslayer 90
