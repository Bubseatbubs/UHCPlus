...
# Spawn Titan
execute in minecraft:overworld positioned 0 200 0 summon minecraft:blaze run function ssiege:titans/infernus/init_helper with storage ssiege:titan_health input
