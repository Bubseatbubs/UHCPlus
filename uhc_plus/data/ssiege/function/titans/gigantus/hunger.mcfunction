...
summon minecraft:silverfish ~ ~ ~ {PersistenceRequired:1b,CanPickUpLoot:0b,Tags:["UHCP_Minion"],Health:20f,CustomName:{"text":"Corpse Eater"},attributes:[{id:"minecraft:attack_damage",base:6.0d},{id:"minecraft:movement_speed",base:0.24d},{id:"minecraft:max_health",base:20.0d},{id:"minecraft:scale",base:4.0d}]}
