...
execute if score %prev_killed uhcp_titans_id matches 1.. run tellraw @a ["",{"text":"Seraphim","bold":true,"color":"red"},{"text":" disappeared..."}]
...
title @a title {"text":"Ferrum","color":"red"}
