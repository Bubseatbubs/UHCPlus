...
execute as @a[scores={ssiege_death_timer=0..},gamemode=spectator] if score @s ssiege_death_timer matches 0 run execute as @s run function ssiege:death/respawn