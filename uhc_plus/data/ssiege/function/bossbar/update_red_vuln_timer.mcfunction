...
scoreboard players operation %red_inhib_sec uhcp_game_time /= %TICKS_PER_SEC uhcp_game_time
scoreboard players operation %red_inhib_min uhcp_game_time = %red_inhib_sec uhcp_game_time
scoreboard players operation %red_inhib_sec uhcp_game_time %= %SEC_PER_MIN uhcp_game_time
scoreboard players operation %red_inhib_min uhcp_game_time /= %SEC_PER_MIN uhcp_game_time
