...
scoreboard players set %count ssiege_giants 5
...
execute if score %count_remainder ssiege_giants matches 1 run scoreboard players remove %spawned ssiege_giants 1
