...
execute if score %blue ssiege_perk_aura matches 3 run scoreboard players operation %blue_cost ssiege_perk_aura *= #4 uhcp_const
...
execute if score %blue ssiege_perk_homeguard matches 2 run scoreboard players operation %blue_cost ssiege_perk_homeguard *= #12 uhcp_const
...
execute if score %blue ssiege_perk_titanslayer matches 7.. run scoreboard players set %blue_cost ssiege_perk_titanslayer 999