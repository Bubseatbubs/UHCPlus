...
execute if score %blue ssiege_perk_regen matches 2 run effect give @a[team=blue] instant_health 1 0 true
...
execute if score %blue ssiege_perk_regen matches 3 run effect give @a[team=blue] instant_health 1 0 true
...
execute if score %blue ssiege_perk_regen matches 4 run effect give @a[team=blue] instant_health 1 0 true
...
execute if score %blue ssiege_perk_regen matches 5 run effect give @a[team=blue] instant_health 1 0 true
