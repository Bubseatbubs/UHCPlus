...
execute if score %blue ssiege_perk_sonar matches 2 at @e[type=marker,tag=BLUE_BASE,limit=1] run execute as @a[team=red,distance=..35,predicate=!uhcp:augments/immune_to_eye] unless data entity @s {active_effects:[{id:"minecraft:glowing"}]} at @s run function ssiege:shop/perks/effects/sonar/red_player_detected
execute if score %blue ssiege_perk_sonar matches 3.. at @e[type=marker,tag=BLUE_BASE,limit=1] run execute as @a[team=red,distance=..50,predicate=!uhcp:augments/immune_to_eye] unless data entity @s {active_effects:[{id:"minecraft:glowing"}]} at @s run function ssiege:shop/perks/effects/sonar/red_player_detected
...
execute if score %red ssiege_perk_sonar matches 2 at @e[type=marker,tag=RED_BASE,limit=1] run execute as @a[team=blue,distance=..35,predicate=!uhcp:augments/immune_to_eye] unless data entity @s {active_effects:[{id:"minecraft:glowing"}]} at @s run function ssiege:shop/perks/effects/sonar/blue_player_detected
execute if score %red ssiege_perk_sonar matches 3.. at @e[type=marker,tag=RED_BASE,limit=1] run execute as @a[team=blue,distance=..50,predicate=!uhcp:augments/immune_to_eye] unless data entity @s {active_effects:[{id:"minecraft:glowing"}]} at @s run function ssiege:shop/perks/effects/sonar/blue_player_detected
