...
execute at @e[tag=BLUE_BASE,limit=1] run execute positioned ~77 ~ ~ as @a[team=blue,distance=..10] unless score @s uhcp_augment matches 529 run effect give @s saturation 4 0 true
execute at @e[tag=RED_BASE,limit=1] run execute positioned ~-77 ~ ~ as @a[team=red,distance=..10] unless score @s uhcp_augment matches 529 run effect give @s saturation 4 0 true
...
# Spawn protection
execute at @e[tag=BLUE_BASE,limit=1] run execute positioned ~77 ~ ~ as @a[team=red,distance=..16,gamemode=survival] run damage @s 12 magic at ~ ~ ~
execute at @e[tag=RED_BASE,limit=1] run execute positioned ~-77 ~ ~ as @a[team=blue,distance=..16,gamemode=survival] run damage @s 12 magic at ~ ~ ~
execute at @e[tag=BLUE_BASE,limit=1] run execute positioned ~77 ~ ~ run tellraw @a[team=red,distance=..16,gamemode=survival] {"text":"You are too close to the enemy spawn!","color":"red"}
