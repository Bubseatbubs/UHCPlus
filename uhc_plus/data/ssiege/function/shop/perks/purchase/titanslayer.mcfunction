...
execute as @s[team=blue] run scoreboard players operation %team_cost ssiege_perk_aura = %blue_cost ssiege_perk_titanslayer
execute as @s[team=red] run scoreboard players operation %team_cost ssiege_perk_aura = %red_cost ssiege_perk_titanslayer
