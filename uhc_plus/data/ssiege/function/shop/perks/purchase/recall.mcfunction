$execute store result score @s ssiege_perk_recall run clear @s diamond $(cost)
...
execute as @s[team=blue] if score @s ssiege_perk_recall < %blue_cost ssiege_perk_recall run execute store result storage ssiege:temp refund int 1 run scoreboard players get @s ssiege_perk_recall
execute as @s[team=blue] if score @s ssiege_perk_recall < %blue_cost ssiege_perk_recall run return run function ssiege:shop/perks/purchase/refund with storage ssiege:temp
execute as @s[team=red] if score @s ssiege_perk_recall < %red_cost ssiege_perk_recall run execute store result storage ssiege:temp refund int 1 run scoreboard players get @s ssiege_perk_recall
...
# Successful purchase
execute as @s[team=blue] run tellraw @a ["",{"selector":"@s"},{"text":" purchased "},{"text":"Recall Speed Level ","color":"green"},{"score":{"name":"%blue","objective":"ssiege_perk_recall"},"color":"green"},{"text":" for ","color":"white"},{"text":"Blue team!","color":"blue"},{"text":" (Cost: ","color":"white"},{"score":{"name":"%blue_cost","objective":"ssiege_perk_recall"},"color":"white"},{"text":")","color":"white"}]
execute as @s[team=red] run tellraw @a ["",{"selector":"@s"},{"text":" purchased "},{"text":"Recall Speed Level ","color":"green"},{"score":{"name":"%red","objective":"ssiege_perk_recall"},"color":"green"},{"text":" for ","color":"white"},{"text":"Red team!","color":"red"},{"text":" (Cost: ","color":"white"},{"score":{"name":"%red_cost","objective":"ssiege_perk_recall"},"color":"white"},{"text":")","color":"white"}]

# Update Perk score
execute as @s[team=blue] run scoreboard players add %blue ssiege_perk_recall 1
execute as @s[team=red] run scoreboard players add %red ssiege_perk_recall 1
