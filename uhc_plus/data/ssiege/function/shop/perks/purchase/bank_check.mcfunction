...
execute if score %bank uhcp_initStatus < %cost ssiege_unlocked_runesmith run return run function ssiege:shop/perks/purchase/refund with storage ssiege:temp shop
