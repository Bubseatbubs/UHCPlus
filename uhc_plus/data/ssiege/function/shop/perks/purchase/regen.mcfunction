...
execute as @s[team=blue] run scoreboard players operation %team_cost ssiege_unlocked_runesmith = %blue_cost ssiege_perk_regen
execute as @s[team=red] run scoreboard players operation %team_cost ssiege_unlocked_runesmith = %red_cost ssiege_perk_regen
