...
execute if score @s ssiege_unlocked_runesmith matches ..23 run scoreboard players set %cost uhcp_initStatus 24
execute if score @s ssiege_unlocked_runesmith matches ..23 run function ssiege:shop/runes/purchase/bank_check
execute if score @s ssiege_unlocked_runesmith matches ..23 run execute store result storage ssiege:temp refund int 1 run scoreboard players get @s ssiege_unlocked_runesmith
execute if score @s ssiege_unlocked_runesmith matches ..23 run return run function ssiege:shop/runes/purchase/refund_consumable with storage ssiege:temp
