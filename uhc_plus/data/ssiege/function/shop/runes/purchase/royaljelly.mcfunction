...
execute if score @s ssiege_unlocked_runesmith matches ..9 run scoreboard players set %cost uhcp_initStatus 10
execute if score @s ssiege_unlocked_runesmith matches ..9 run function ssiege:shop/runes/purchase/bank_check
execute if score @s ssiege_unlocked_runesmith matches ..9 run execute store result storage ssiege:temp refund int 1 run scoreboard players get @s ssiege_unlocked_runesmith
execute if score @s ssiege_unlocked_runesmith matches ..9 run return run function ssiege:shop/runes/purchase/refund_consumable with storage ssiege:temp

loot give @s loot uhcp:consumables/royal_jelly

tellraw @s ["",{"text":"You purchased an "},{"text":"Royal Jelly","color":"yellow"},{"text":"!"}]
