...
execute if score @s ssiege_unlocked_runesmith < @s ssiege_rune_swiftness_cost run scoreboard players operation %cost ssiege_unlocked_runesmith = @s ssiege_rune_swiftness_cost
execute if score @s ssiege_unlocked_runesmith < @s ssiege_rune_swiftness_cost run function ssiege:shop/runes/purchase/bank_check
execute if score @s ssiege_unlocked_runesmith < @s ssiege_rune_swiftness_cost run execute store result storage ssiege:temp shop.refund int 1 run scoreboard players get @s ssiege_unlocked_runesmith
execute if score @s ssiege_unlocked_runesmith < @s ssiege_rune_swiftness_cost run return run function ssiege:shop/runes/purchase/refund with storage ssiege:temp shop
