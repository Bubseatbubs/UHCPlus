...
execute if score @s ssiege_unlocked_runesmith < @s ssiege_rune_toughness_cost run scoreboard players operation %cost uhcp_initStatus = @s ssiege_rune_toughness_cost
