...
execute if score @s ssiege_unlocked_runesmith < %cost ssiege_unlocked_runesmith run return run function ssiege:shop/runes/purchase/refund_consumable with storage ssiege:temp shop
return 1