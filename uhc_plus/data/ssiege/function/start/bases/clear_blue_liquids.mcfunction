...
fill 176 ~-1 223 223 ~9 173 minecraft:air replace minecraft:water
...
fill 224 ~-1 196 265 ~9 203 minecraft:air replace minecraft:water
...
fill 266 ~-1 189 286 ~9 210 minecraft:air replace minecraft:water
