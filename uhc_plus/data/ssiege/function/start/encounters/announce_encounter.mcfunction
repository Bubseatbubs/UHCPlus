execute if score %encounter ssiege_current_encounter matches 1 run tellraw @a [{"text":"Bubson","color":"gold"},{"text":" causes extra Titans to spawn this game.","color":"white"}]
...
execute if score %encounter ssiege_current_encounter matches 19 run tellraw @a [{"text":"Neo","color":"gold"},{"text":" gives everyone a Fortune book.","color":"white"}]
