...
execute if score %encounter ssiege_current_encounter matches 14 run return fail
execute if score %encounter ssiege_current_encounter matches 15 run return fail
