...
execute as @s[team=blue] if score %blue ssiege_perk_recall matches 2 run tellraw @s {text:"Channeling recall for 7 seconds...",color:light_purple}
execute as @s[team=red] if score %red ssiege_perk_recall matches 2 run scoreboard players set @s ssiege_recall_charge 140
execute as @s[team=red] if score %red ssiege_perk_recall matches 2 run tellraw @s {text:"Channeling recall for 7 seconds...",color:light_purple}

execute as @s[team=blue] if score %blue ssiege_perk_recall matches ..2 run tellraw @s {text:"(Decrease channel duration by purchasing Recall Speed for your team at the Perk Shop)",color:light_purple}
execute as @s[team=red] if score %red ssiege_perk_recall matches ..2 run tellraw @s {text:"(Decrease channel duration by purchasing Recall Speed for your team at the Perk Shop)",color:light_purple}

execute as @s[team=blue] if score %blue ssiege_perk_recall matches 3.. run scoreboard players set @s ssiege_recall_charge 80
execute as @s[team=blue] if score %blue ssiege_perk_recall matches 3 run tellraw @s {text:"Channeling recall for 4 seconds...",color:light_purple}
execute as @s[team=red] if score %red ssiege_perk_recall matches 3.. run scoreboard players set @s ssiege_recall_charge 80
execute as @s[team=red] if score %red ssiege_perk_recall matches 3 run tellraw @s {text:"Channeling recall for 4 seconds...",color:light_purple}
