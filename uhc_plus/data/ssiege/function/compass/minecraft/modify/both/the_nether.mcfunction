# Modify compasses for Nether
data modify storage uhcp:compass Compass.hand[].components."minecraft:lodestone_tracker".target.dimension set value "minecraft:the_nether"
...
data modify storage uhcp:compass Compass.hand[].components."minecraft:lodestone_tracker".target.pos[1] set value 0
