...
execute if score @s uhcp_initStatus matches 1 run return run function uhcp:consumables/wild_feather/remove/mainhand
scoreboard players remove @s uhcp_initStatus 1
item modify entity @s weapon.mainhand uhcp:count
function uhcp:consumables/wild_feather/init
