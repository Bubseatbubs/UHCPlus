...
execute if score %compass_jump uhcp_itemInv matches 1 run return run function uhcp:compass/dimension/lodestone/maximum/found with storage uhcp:compass Current

scoreboard players operation %compass_max uhcp_itemInv = %compass_height uhcp_itemInv
scoreboard players operation %compass_max uhcp_itemInv += %compass_jump uhcp_itemInv
execute if score %compass_max uhcp_itemInv matches 6095.. run scoreboard players set %compass_max uhcp_itemInv 6094
scoreboard players operation %compass_range uhcp_itemInv = %compass_max uhcp_itemInv
