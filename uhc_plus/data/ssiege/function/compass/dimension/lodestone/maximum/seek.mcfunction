...
execute if score %compass_bool uhcp_itemInv matches 1 run return run function uhcp:compass/dimension/lodestone/maximum/hit

scoreboard players remove %compass_stage uhcp_itemInv 1
execute if score %compass_stage uhcp_itemInv matches 1.. run return run function uhcp:compass/dimension/lodestone/maximum/seek
