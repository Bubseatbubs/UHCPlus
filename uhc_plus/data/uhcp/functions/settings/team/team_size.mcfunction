...
execute if score @s uhcp_settings matches 507 run function uhcp:settings/team/team_size/lower/15
...
execute if score @s uhcp_settings matches 511 run function uhcp:settings/team/team_size/raise/15
...
execute if score %team_size uhcp_settings matches 500.. run scoreboard players set %team_size uhcp_settings 499
