...
execute unless score %uhcp_gameStart uhcp_initStatus matches 1.. unless score %uhcp_lavaInit uhcp_initStatus matches 1.. if score @s uhcp_settings matches 218..225 run function uhcp:settings/lava/countdown
