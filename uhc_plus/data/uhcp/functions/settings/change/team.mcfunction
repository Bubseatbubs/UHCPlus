...
execute unless score %game uhcp_initStatus matches 1 run execute if score @s uhcp_settings matches 502..503 run function uhcp:settings/team/players_select_teams
