...
execute if score %time_calcM uhcp_gameTime matches 0..9 run function uhcp:settings/other/dimensions/notify/single
execute if score %time_calcM uhcp_gameTime matches 10..59 run function uhcp:settings/other/dimensions/notify/double
