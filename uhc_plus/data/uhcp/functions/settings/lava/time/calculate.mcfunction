...
execute if score %time_calcM uhcp_game_time matches 0..9 run function uhcp:settings/lava/time/notify/single
execute if score %time_calcM uhcp_game_time matches 10..59 run function uhcp:settings/lava/time/notify/double
