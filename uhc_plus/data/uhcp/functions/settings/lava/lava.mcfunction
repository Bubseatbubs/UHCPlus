...
execute unless score %uhcp_lavaStart uhcp_initStatus matches 1.. unless score %uhcp_gameStart uhcp_initStatus matches 1.. if score @s uhcp_settings matches 830..839 run function uhcp:settings/lava/countdown
