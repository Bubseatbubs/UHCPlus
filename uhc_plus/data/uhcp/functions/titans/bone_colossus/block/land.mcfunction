execute at @s as @e[type=!#uhcp:inanimate_mobs,distance=..3] unless score @s uhcp_team = @e[tag=UHCP_BoneBlock,sort=nearest,limit=1] uhcp_team run damage @s 8 minecraft:falling_block
