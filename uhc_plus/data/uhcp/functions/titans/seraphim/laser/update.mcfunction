...
execute if score @s uhcp_timer matches 5 at @s as @a[distance=..32] at @s run playsound block.beacon.activate master @s ~ ~ ~ 100 2 1
...
execute store result score %blocksfilled uhcp_titans_count run fill ~-1.5 ~-0.5 ~-1.5 ~1.5 ~128 ~1.5 air replace #uhcp:titan_can_break
execute store result score %blocksfilled uhcp_titans_count run fill ~-1.5 ~-1.5 ~-1.5 ~1.5 ~-1.5 ~1.5 smooth_quartz replace #uhcp:titan_can_break
...
execute if score @s uhcp_timer matches 50 run particle flash ~ ~ ~ 1 1 1 1 5 force
