...
execute store result score %blocksfilled uhcp_titans_count run fill ~-1.5 ~-0.5 ~-1.5 ~1.5 ~128 ~1.5 minecraft:air replace #uhcp:titan_can_break
execute store result score %blocksfilled uhcp_titans_count run fill ~-1.5 ~-1.5 ~-1.5 ~1.5 ~-1.5 ~1.5 minecraft:smooth_quartz replace #uhcp:titan_can_break
