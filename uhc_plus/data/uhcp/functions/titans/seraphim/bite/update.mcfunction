...
execute if score @s uhcp_a_timer matches ..10 facing entity @p[gamemode=survival] eyes run tp @s ^ ^ ^0.1 ~ ~
execute unless score @s uhcp_a_timer matches 10.. run return 0
...
execute if score @s uhcp_a_timer matches 30.. run tag @s remove UHCP_Bite
execute if score @s uhcp_a_timer matches 30.. run scoreboard players reset @s uhcp_a_timer