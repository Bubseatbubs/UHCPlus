...
execute as @a[distance=..3,gamemode=survival] run damage @s 6 falling_block
fill ~-3 ~-2 ~-4 ~3 ~ ~4 minecraft:netherrack replace #uhcp:titan_can_break
fill ~-4 ~-2 ~-3 ~4 ~ ~3 minecraft:netherrack replace #uhcp:titan_can_break
execute store result score %random uhcp_titans_count run random value 0..4
execute if score %random uhcp_titans_count matches 0 run summon piglin ~ ~ ~ {Health:4f,IsImmuneToZombification:1b,CannotHunt:1b,Tags:["UHCP_Minion"],HandItems:[{id:"minecraft:crossbow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{},{id:"minecraft:golden_helmet",count:1,components:{"minecraft:trim":{material:"minecraft:copper",pattern:"minecraft:snout"}}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Attributes:[{Name:generic.max_health,Base:6}]}
execute if score %random uhcp_titans_count matches 0 run summon piglin ~ ~ ~ {Health:4f,IsImmuneToZombification:1b,CannotHunt:1b,Tags:["UHCP_Minion"],HandItems:[{id:"minecraft:crossbow",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{},{id:"minecraft:golden_helmet",count:1,components:{"minecraft:trim":{material:"minecraft:copper",pattern:"minecraft:snout"}}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Attributes:[{Name:generic.max_health,Base:6}]}
execute if score %random uhcp_titans_count matches 1 run summon magma_cube ~ ~ ~ {Health:3f,Size:2,Tags:["UHCP_Minion"],Attributes:[{Name:generic.attack_damage,Base:4},{Name:generic.scale,Base:3}]}
execute if score %random uhcp_titans_count matches 2 run summon wither_skeleton ~ ~ ~ {Health:3f,Tags:["UHCP_Minion"],HandItems:[{id:"minecraft:stone_sword",count:1},{}],HandDropChances:[0.000F,0.085F]} 
execute if score %random uhcp_titans_count matches 3 run summon piglin_brute ~ ~ ~ {Health:6f,IsImmuneToZombification:1b,CannotHunt:1b,Tags:["UHCP_Minion"],HandItems:[{id:"minecraft:golden_axe",count:1},{}],HandDropChances:[0.000F,0.085F],ArmorItems:[{},{},{},{id:"minecraft:netherite_helmet",count:1,components:{"minecraft:trim":{material:"minecraft:copper",pattern:"minecraft:snout"}}}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Attributes:[{Name:generic.max_health,Base:6},{Name:generic.attack_damage,Base:4}]}
execute if score %random uhcp_titans_count matches 4 run summon strider ~ ~ ~ {Health:1f,Tags:["UHCP_Minion"]} 
