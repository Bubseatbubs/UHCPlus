...
execute as @s facing entity @p[gamemode=survival,distance=..32] feet positioned ^ ^ ^20 rotated ~ 0 run summon minecraft:marker ~ ~ ~ {Tags:["UHCP_GallieDashMarker","UHCP_New","UHCP_Summon"]}
