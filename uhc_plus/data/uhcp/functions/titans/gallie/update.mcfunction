...
execute as @e[type=!#uhcp:inanimate_mobs,tag=!UHCP_Titan,tag=!UHCP_Minion,distance=..4.25] run damage @s 4 minecraft:mob_attack by @e[tag=UHCP_CurrentTitan,sort=nearest,limit=1]
