...
execute as @e[tag=UHCP_LightningWave1] on passengers run scoreboard players set @s uhcp_a_timer 0
...
execute as @e[tag=UHCP_LightningWave2] on passengers run scoreboard players set @s uhcp_a_timer -10
...
execute as @e[tag=UHCP_LightningWave3] on passengers run scoreboard players set @s uhcp_a_timer -20
