...
execute store result score @s uhcp_titans_count run random value 1..7
execute in minecraft:overworld run spreadplayers 0 0 10 300 false @s
...
execute at @s run function uhcp:titans/spawn/finish
