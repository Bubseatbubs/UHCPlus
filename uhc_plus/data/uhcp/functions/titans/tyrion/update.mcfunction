...
execute as @a[distance=..3.5] run damage @s 1 minecraft:mob_attack by @e[tag=UHCP_CurrentTitan,sort=nearest,limit=1]
execute as @e[type=!minecraft:player,type=!#uhcp:inanimate_mobs,tag=!UHCP_Titan,tag=!UHCP_Minion,distance=..3.5] run damage @s 10 minecraft:mob_attack by @e[tag=UHCP_CurrentTitan,sort=nearest,limit=1]
