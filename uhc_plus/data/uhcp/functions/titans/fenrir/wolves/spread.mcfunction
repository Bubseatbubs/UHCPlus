...
execute at @e[tag=UHCP_WolfMarker] run summon wolf ~ ~ ~ {Tags:["UHCP_FenrirMinion","UHCP_Summon","UHCP_Init"],Health:5f,Motion:[0.0,0.8,0.0],CustomNameVisible:0b,PersistenceRequired:1b,Attributes:[{Name:"generic.max_health",Base:20},{Name:"generic.knockback_resistance",Base:0},{Name:"generic.attack_damage",Base:5},{Name:"generic.armor",Base:1}]}
