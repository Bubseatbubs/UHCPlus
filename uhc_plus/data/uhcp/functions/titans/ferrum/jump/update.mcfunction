...
fill ~-8 ~ ~-8 ~8 ~18 ~8 air replace #uhcp:titan_can_break
execute at @s if score @s uhcp_timer matches 25.. unless entity @e[tag=UHCP_FerrumLanding,distance=..2] run fill ~-8 ~-4 ~-8 ~8 ~ ~8 air replace #uhcp:titan_can_break
