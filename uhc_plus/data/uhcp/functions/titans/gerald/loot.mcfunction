...
execute at @s run summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["UHCP_GeraldMarker"]}
execute at @s run summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["UHCP_GeraldMarker"]}
execute at @s run summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["UHCP_GeraldMarker"]}
execute at @s run summon marker ~ ~ ~ {CustomNameVisible:0b,Tags:["UHCP_GeraldMarker"]}
...
execute at @e[tag=UHCP_GeraldMarker] run data merge entity @e[type=item,sort=nearest,limit=1] {Glowing:1b}
execute at @e[tag=UHCP_GeraldMarker] run particle block{block_state: "minecraft:dirt"} ~ ~ ~ 0.5 0.5 0.5 0.1 100 normal
