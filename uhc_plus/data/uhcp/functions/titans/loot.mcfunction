...
execute as @a[distance=..16,gamemode=survival,scores={uhcp_augment=208}] at @s run loot replace entity @e[type=item,tag=UHCP_NewLoot,sort=nearest,limit=1] contents loot uhcp:consumables/titan_spinal_fluid
