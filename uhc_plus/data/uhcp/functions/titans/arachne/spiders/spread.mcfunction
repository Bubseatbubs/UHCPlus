...
execute at @e[tag=UHCP_SpiderMarker] run summon spider ~ ~ ~ {Motion:[0.0,0.8,0.0],CustomNameVisible:0b,PersistenceRequired:1b,Health:20f,Tags:["UHCP_ArachneSpider","UHCP_Init"],Attributes:[{Name:"generic.max_health",Base:20},{Name:"generic.knockback_resistance",Base:0},{Name:"generic.attack_damage",Base:5},{Name:"generic.armor",Base:1}]}
