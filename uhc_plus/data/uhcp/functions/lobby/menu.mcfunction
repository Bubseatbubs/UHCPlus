...
execute unless entity @s[tag=UHCP_RelicTestingChamber] run item replace entity @s hotbar.6 with black_stained_glass_pane[minecraft:item_name='{"text":"Menu Selection","color":"gold"}',minecraft:hide_tooltip={}] 1
...
# Among Us
execute if score @s uhcp_lobby_item matches 7 run item replace entity @p armor.head with player_head[custom_name='{"text":"Crewmate"}',lore=['{"text":"STOP POSTING ABOUT AMONG US"}'],profile={id:[I;1103181598,442909615,-1944221175,-54642410],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZjg5YmNlNzM2YTRmZDc5M2VlMmEzODI3NTZhMjUzZjkyY2E3ZDdlYWMwMzFlNDViYTk3YWQwNmNlODYzZGQ0YiJ9fX0="}]}] 1
