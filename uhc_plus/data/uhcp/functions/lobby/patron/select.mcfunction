...
execute if score @s patron matches 100 run scoreboard players set @s uhcp_aug_patron 0
...
execute if score @s patron matches 101 run scoreboard players set @s uhcp_aug_patron 1
...
execute if score @s patron matches 102 run scoreboard players set @s uhcp_aug_patron 2
...
execute if score @s patron matches 103 run scoreboard players set @s uhcp_aug_patron 3
...
execute if score @s patron matches 104 run scoreboard players set @s uhcp_aug_patron 4
...
execute if score @s patron matches 105 run scoreboard players set @s uhcp_aug_patron 5
...
execute if score @s patron matches 106 run scoreboard players set @s uhcp_aug_patron 6
...
execute if score @s patron matches 107 run scoreboard players set @s uhcp_aug_patron 7
...
execute if score @s patron matches 108 run scoreboard players set @s uhcp_aug_patron 8
...
execute if score @s patron matches 109 run scoreboard players set @s uhcp_aug_patron 9
