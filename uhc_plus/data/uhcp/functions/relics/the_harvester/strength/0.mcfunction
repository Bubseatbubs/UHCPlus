# 0 Gapples
execute at @s as @e[type=!#uhcp:inanimate_mobs,distance=..2.25] unless score @s uhcp_team = @e[tag=UHCP_GoldBlock,sort=nearest,limit=1] uhcp_team run damage @s 4 falling_block
