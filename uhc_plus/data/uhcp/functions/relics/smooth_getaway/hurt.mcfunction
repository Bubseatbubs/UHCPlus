...
execute as @e[tag=UHCP_SClone] if score @s uhcp_id = @e[tag=UHCP_CurrentHitbox,sort=nearest,limit=1] uhcp_id run damage @s 0.1 minecraft:generic by @e[tag=UHCP_Attacker,sort=nearest,limit=1]
