...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:diamond_sword",Count:1b}}] run scoreboard players remove %damage uhcp_a_durability 67
execute if entity @s[nbt={SelectedItem:{id:"minecraft:golden_sword",Count:1b}}] run scoreboard players remove %damage uhcp_a_durability 50
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow",Count:1b}}] run scoreboard players remove %damage uhcp_a_durability 93
