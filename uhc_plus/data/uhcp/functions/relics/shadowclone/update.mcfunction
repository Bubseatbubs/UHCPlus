...
execute as @e[tag=UHCP_SClone] if score @s uhcp_team = @e[tag=UHCP_Teleport,sort=nearest,limit=1] uhcp_team run tag @s add UHCP_Target
...
execute as @e[tag=UHCP_Target,type=wolf] run data modify entity @s AngryAt set from entity @e[tag=UHCP_AttackTarget,sort=nearest,limit=1] UUID
...
tp @e[tag=UHCP_Target,type=wolf,sort=nearest,limit=1] 0 -64 0
kill @e[tag=UHCP_Target,type=wolf,sort=nearest,limit=1]
