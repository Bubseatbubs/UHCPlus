execute store result score %current_damage uhcp_a_durability run data get entity @s Inventory[{Slot:101b}].components."minecraft:damage"
...
execute store result score %max_damage uhcp_a_durability run data get entity @s Inventory[{Slot:101b}].components."minecraft:max_damage"
scoreboard players operation %damage uhcp_a_durability /= %max_damage uhcp_a_durability
item modify entity @s armor.legs uhcp:update_dur