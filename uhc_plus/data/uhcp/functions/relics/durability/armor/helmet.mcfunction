execute store result score %current_damage uhcp_a_durability run data get entity @s Inventory[{Slot:103b}].components."minecraft:damage"
...
execute store result score %max_damage uhcp_a_durability run data get entity @s Inventory[{Slot:103b}].components."minecraft:max_damage"
