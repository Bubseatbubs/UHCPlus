...
execute if score %uhcp_compassTime uhcp_itemCount matches ..0 if entity @a[predicate=uhcp:compass/player_compass/hand,gamemode=survival] run function uhcp:compass
