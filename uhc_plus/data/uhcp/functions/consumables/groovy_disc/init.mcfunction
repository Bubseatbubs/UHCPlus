...
tellraw @a[distance=..50] [{"selector":"@s","color":"#47FF4E"},{"text":" started a rave... you were inflicted with","color":"#00FF22","bold":false},{"text":" Blindness and Glowing!","color":"dark_red"}]
