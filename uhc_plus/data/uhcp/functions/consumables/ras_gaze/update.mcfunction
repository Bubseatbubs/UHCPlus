...
execute unless entity @a[tag=UHCP_RaTarget] facing entity @e[tag=!UHCP_Invulnerable,tag=!UHCP_RaImmune,type=!player,type=!#uhcp:inanimate_mobs,distance=..32,sort=nearest,limit=1] feet run tp @s ^ ^ ^0.36
