...
execute as @a[distance=..16] at @s run playsound entity.wither.spawn master @s ~ ~ ~ 0.5 0.75 0.5
execute as @a[distance=..16] at @s run playsound item.trident.thunder master @s ~ ~ ~ 100 0.75 1
execute as @a[distance=..16] at @s run playsound item.trident.thunder master @s ~ ~ ~ 100 0.75 1
...
scoreboard players operation @e[tag=UHCP_New,tag=UHCP_RaLaser,sort=nearest,limit=1] uhcp_id = @s uhcp_id
scoreboard players operation @e[tag=UHCP_New,tag=UHCP_RaLaser,sort=nearest,limit=1] uhcp_team = @s uhcp_team
