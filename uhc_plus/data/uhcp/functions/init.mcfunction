...
summon minecraft:text_display 7 303 7 {Tags:["UHCP_Lobby"],billboard:"center",text:'[{"text":"U","color":"#0346FF"},{"text":"H","color":"#0080FF"},{"text":"C ","color":"#0091FF"},{"text":"+","color":"#05CDFF","bold":true}]'}
