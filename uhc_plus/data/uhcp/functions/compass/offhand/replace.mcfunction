...
execute if score %compass_age uhcp_itemInv matches 61.. run function uhcp:compass/offhand/offhand
execute if score %compass_age uhcp_itemInv matches 0..60 run function uhcp:compass/offhand/age
