...
execute store result storage uhcp:compass Compass.hand[1].components."minecraft:custom_data".compass_time byte 1 run scoreboard players get %uhcp_compassAge uhcp_itemInv
