...
execute if score %compass_age uhcp_itemCount matches 0 run data remove storage uhcp:compass Compass.hand[1]

# Track item in array
execute if score %compass_age uhcp_itemCount matches ..0 run data remove storage uhcp:compass Track[-1]
execute if score %compass_age uhcp_itemCount matches 1.. run data modify storage uhcp:compass Track[-1].count set from storage uhcp:compass Compass.hand[1].count
