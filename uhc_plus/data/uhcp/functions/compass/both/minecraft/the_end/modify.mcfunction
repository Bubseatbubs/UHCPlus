...
data modify storage minecraft:uhcp_compass Compass.hand[1].tag.LodestoneDimension set value "minecraft:the_end"
...
data modify storage minecraft:uhcp_compass Compass.hand[1].tag.LodestonePos.Y set value 255
