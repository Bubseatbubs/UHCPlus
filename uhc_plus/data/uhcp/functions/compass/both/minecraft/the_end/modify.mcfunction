...
# Modify compasses
data modify storage minecraft:uhcp_compass Compass.hand[].tag.LodestoneDimension set value "minecraft:the_end"
...
data modify storage minecraft:uhcp_compass Compass.hand[].tag.LodestonePos.Y set value 255
