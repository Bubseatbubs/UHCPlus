...
execute if score %uhcp_compassAge uhcp_itemInv matches 121.. run function uhcp:compass/mainhand/mainhand
execute if score %uhcp_compassAge uhcp_itemInv matches 0..120 run function uhcp:compass/mainhand/age
