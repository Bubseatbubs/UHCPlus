...
execute if score %compass_found uhcp_itemInv matches 0 run function uhcp:compass/replace/hand1/compare/missing
execute if score %compass_found uhcp_itemInv matches 1 run function uhcp:compass/replace/hand1/compare/count
