# Search
data modify storage uhcp:compass Work set from storage uhcp:compass Compass.hand[1].components."minecraft:custom_data".uuid
...
execute store result score %uhcp_compassFound uhcp_itemInv run function uhcp:compass/replace/hand1/compare/find
