...
summon item ~ ~ ~ {Motion:[0.0,0.5,0.0],Glowing:1b,PickupDelay:20,Tags:["UHCP_BoneCageBone"],Item:{id:"minecraft:bone",count:1,components:{"minecraft:max_stack_size":1,"minecraft:custom_data":{uhcp_bonecage:1b}}}}
summon item ~ ~ ~ {Motion:[0.0,0.5,0.0],Glowing:1b,PickupDelay:20,Tags:["UHCP_BoneCageBone"],Item:{id:"minecraft:bone",count:1,components:{"minecraft:max_stack_size":1,"minecraft:custom_data":{uhcp_bonecage:1b}}}}
