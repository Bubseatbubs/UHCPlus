...
# Game time
scoreboard players add %time uhcp_gameTime 1

# World border
execute unless score %border_countdown uhcp_gameTime matches ..-1 run function uhcp:border
...
# Eternal day
execute if score %time uhcp_gameTime matches 24000..24500 in minecraft:overworld run function uhcp:day/run
