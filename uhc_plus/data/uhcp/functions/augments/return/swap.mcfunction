...
execute if score @s uhcp_a_validSelection matches 2 run function uhcp:augments/return/slot/swap/0
execute if score @s uhcp_a_validSelection matches 3 run function uhcp:augments/return/slot/swap/1
execute if score @s uhcp_a_validSelection matches 4 run function uhcp:augments/return/slot/swap/2
execute if score @s uhcp_a_validSelection matches 5 run function uhcp:augments/return/slot/swap/6
execute if score @s uhcp_a_validSelection matches 6 run function uhcp:augments/return/slot/swap/8
