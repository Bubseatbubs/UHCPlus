...
execute store success score @s[scores={uhcp_aug_validSelection=0}] uhcp_aug_validSelection if items entity @s player.cursor minecraft:black_stained_glass_pane

# Check if augment selection item is in improper slot
execute unless items entity @s container.0 minecraft:black_stained_glass_pane if items entity @s container.0 * run scoreboard players set @s uhcp_aug_validSelection 2
execute unless items entity @s container.1 minecraft:black_stained_glass_pane if items entity @s container.1 * run scoreboard players set @s uhcp_aug_validSelection 3
execute unless items entity @s container.2 minecraft:black_stained_glass_pane if items entity @s container.2 * run scoreboard players set @s uhcp_aug_validSelection 4
execute unless items entity @s container.6 minecraft:black_stained_glass_pane if items entity @s container.6 * run scoreboard players set @s uhcp_aug_validSelection 5
execute unless items entity @s container.8 minecraft:black_stained_glass_pane if items entity @s container.8 * run scoreboard players set @s uhcp_aug_validSelection 6

# Check if augment selection items shuffled
execute if score @s uhcp_aug_validSelection matches 0 unless items entity @s player.cursor * run scoreboard players set @s uhcp_aug_validSelection 7

# Based on if selection was valid, continue with optionselected, else return the item
execute as @s[scores={uhcp_aug_validSelection=0},tag=!UHCP_DisableChoose] at @s run function uhcp:augments/optionselected
