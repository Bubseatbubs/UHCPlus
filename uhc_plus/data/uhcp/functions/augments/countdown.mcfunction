...
execute if score %uhcp_augmentCountdown uhcp_gameTime matches ..883 as @a[gamemode=adventure] at @s run ride @s mount @e[tag=UHCP_Lock,distance=..4,sort=nearest,limit=1]
