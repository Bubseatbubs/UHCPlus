advancement revoke @s only uhcp:augments/hurt_with_harvester
...
execute if score @s uhcp_a_count matches 1..4 at @e[tag=UHCP_HarvesterTarget] anchored eyes run summon armor_stand ~ ~5 ~ {NoGravity:0b,Silent:1b,Small:1b,Invisible:1b,Tags:["UHCP_New","UHCP_GoldBlock"],Passengers:[{id:"minecraft:block_display",NoGravity:0b,Tags:["UHCP_GBDisplay"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.25f,-1.25f,-1.25f],scale:[2.5f,2.5f,2.5f]},block_state:{Name:"minecraft:gold_block"}}]}
execute if score @s uhcp_a_count matches 5..8 at @e[tag=UHCP_HarvesterTarget] anchored eyes run summon armor_stand ~ ~5 ~ {NoGravity:0b,Silent:1b,Small:1b,Invisible:1b,Tags:["UHCP_New","UHCP_GoldBlock"],Passengers:[{id:"minecraft:block_display",NoGravity:0b,Tags:["UHCP_GBDisplay"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.5f,-1.5f,-1.5f],scale:[3f,3f,3f]},block_state:{Name:"minecraft:gold_block"}}]}
execute if score @s uhcp_a_count matches 9..12 at @e[tag=UHCP_HarvesterTarget] anchored eyes run summon armor_stand ~ ~5 ~ {NoGravity:0b,Silent:1b,Small:1b,Invisible:1b,Tags:["UHCP_New","UHCP_GoldBlock"],Passengers:[{id:"minecraft:block_display",NoGravity:0b,Tags:["UHCP_GBDisplay"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.75f,-1.75f,-1.75f],scale:[3.5f,3.5f,3.5f]},block_state:{Name:"minecraft:gold_block"}}]}
execute if score @s uhcp_a_count matches 13..16 at @e[tag=UHCP_HarvesterTarget] anchored eyes run summon armor_stand ~ ~5 ~ {NoGravity:0b,Silent:1b,Small:1b,Invisible:1b,Tags:["UHCP_New","UHCP_GoldBlock"],Passengers:[{id:"minecraft:block_display",NoGravity:0b,Tags:["UHCP_GBDisplay"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-2f,-2f,-2f],scale:[4f,4f,4f]},block_state:{Name:"minecraft:gold_block"}}]}
