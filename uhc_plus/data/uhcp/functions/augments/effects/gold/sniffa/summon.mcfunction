...
summon minecraft:sniffer ~ ~ ~ {PersistenceRequired:1b,Invulnerable:1b,Tags:["UHCP_Sniffa","UHCP_Summon","UHCP_InitScore","UHCP_Invulnerable"],Attributes:[{Name:"generic.scale",Base:0.5}],CustomName:'{"text":"SNIFFA","color":"gold","bold":true,"underlined":true}'}
