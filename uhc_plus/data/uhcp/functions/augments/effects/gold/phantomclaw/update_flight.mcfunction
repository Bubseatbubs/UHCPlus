...
execute at @s as @e[tag=!UHCP_Owner,tag=!UHCP_TeamMember,type=!#uhcp:inanimate_mobs,distance=..2.5] run damage @s 2 uhcp:instant_damage by @a[tag=UHCP_Owner,sort=nearest,limit=1]
