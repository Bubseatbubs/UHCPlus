...
execute at @s as @e[distance=..2.5] unless score @s uhcp_id = @e[tag=UHCP_MadeToDestination,sort=nearest,limit=1] uhcp_id run damage @s 2 uhcp:instant_damage by @a[tag=UHCP_Owner,sort=nearest,limit=1]
