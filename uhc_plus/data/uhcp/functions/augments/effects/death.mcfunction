...
execute if score @s[tag=UHCP_Explode] uhcp_a_selectedAugment matches 210 run summon minecraft:creeper ~ ~ ~ {Fuse:0}
...
execute as @a[distance=..10] if score @s uhcp_a_selectedAugment matches 223 at @s run function uhcp:augments/effects/prismatic/soulsiphoner/heal
