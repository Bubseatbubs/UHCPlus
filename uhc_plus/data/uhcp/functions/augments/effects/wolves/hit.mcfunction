...
execute if score @s uhcp_augment matches 200 run scoreboard players add @s uhcp_wolf_stack 1
...
execute as @e[tag=!UHCP_Owner,tag=!UHCP_BeastWolf,type=!#uhcp:inanimate_mobs,distance=..5] store result score @s uhcp_aug_count run function uhcp:augments/effects/wolves/checkattacker
tag @e[scores={uhcp_aug_count=1},distance=..5,sort=nearest,limit=1] add UHCP_BeastWolfTarget
