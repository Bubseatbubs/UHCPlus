...
execute if score @s uhcp_game_time >= @s uhcp_aug_cd_time run function uhcp:augments/effects/silver/ironwill/clear
execute unless score @s uhcp_game_time matches ..-1 run scoreboard players operation @s uhcp_game_time = @s uhcp_aug_cd_time
