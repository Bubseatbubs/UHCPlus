...
execute if score @s uhcp_aug_count matches 20 run playsound block.note_block.pling master @s ~ ~ ~ 1 1 1
execute if score @s uhcp_aug_count matches 40 run playsound block.note_block.pling master @s ~ ~ ~ 1 1 1
...
execute if score @s uhcp_aug_tier matches 1 run return run function uhcp:augments/effects/silver/prophunt/reset
