...
execute unless entity @s[tag=!UHCP_CD_ProtII,tag=!UHCP_CD_ProtIII] run return run give @p minecraft:enchanted_book[minecraft:stored_enchantments={protection:2}]
