...
execute as @e[type=!#uhcp:inanimate_mobs,distance=..36] if score @s uhcp_team = @e[tag=UHCP_CurrentRaLaser,sort=nearest,limit=1] uhcp_team run tag @s add UHCP_RaImmune
...
execute as @e[type=!#uhcp:inanimate_mobs,distance=..3] unless score @s uhcp_team = @e[tag=UHCP_CurrentRaLaser,sort=nearest,limit=1] uhcp_team run damage @s 10 uhcp:instant_damage by @e[tag=UHCP_RaLaser,sort=nearest,limit=1]
