...
execute as @e[type=minecraft:wolf,tag=UHCP_New,sort=random,limit=1] run data merge entity @s {Health:80f,HandItems:[{id:"minecraft:diamond_axe",components:{"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}}}},{}],body_armor_item:{id:"minecraft:wolf_armor",Count:1b},Attributes:[{Name:"generic.max_health",Base:80},{Name:"generic.scale",Base:2.0},{Name:"generic.movement_speed",Base:0.4},{Name:"generic.knockback_resistance",Base:0.25},{Name:"generic.armor",Base:10},{Name:"generic.armor_toughness",Base:1}]}
