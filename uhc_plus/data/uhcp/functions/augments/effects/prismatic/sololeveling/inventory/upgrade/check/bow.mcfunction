...
execute if score @s uhcp_a_tier matches 15..18 if score %uhcp_sLStage uhcp_itemInv matches ..2 run function uhcp:augments/effects/prismatic/sololeveling/inventory/upgrade/bow/3
