...
execute if score @s uhcp_a_tier matches 15..17 if score %uhcp_sLStage uhcp_itemInv matches ..7 run function uhcp:augments/effects/prismatic/sololeveling/inventory/upgrade/axe/8
execute if score @s uhcp_a_tier matches 18 if score %uhcp_sLStage uhcp_itemInv matches ..8 run function uhcp:augments/effects/prismatic/sololeveling/inventory/upgrade/axe/9
