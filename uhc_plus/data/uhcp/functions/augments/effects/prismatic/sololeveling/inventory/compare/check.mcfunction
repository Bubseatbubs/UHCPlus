...
execute store success score %uhcp_sLTool uhcp_itemInv run data modify storage uhcp:solo_level InventoryWork[-1].components."minecraft:custom_data".solo_level set value 1b
