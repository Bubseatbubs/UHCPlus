...
execute as @s run tellraw @s[tag=!UHCP_Creeper,advancements={uhcp:augments/hunters_blessing/killed_creeper=true}] [{"text":"Creepers ","color":"dark_red","bold":true},{"text":"Slain","color":"gray"},{"text":": [","color":"gray"},{"score":{"name":"@s","objective":"uhcp_aug_hb_killedCreeper"},"color":"light_purple"},{"text":"/5]","color":"gray"}]
...
execute as @s run tellraw @s[tag=!UHCP_Zombie,advancements={uhcp:augments/hunters_blessing/killed_zombie=true}] [{"text":"Zombies ","color":"dark_red","bold":true},{"text":"Slain","color":"gray"},{"text":": [","color":"gray"},{"score":{"name":"@s","objective":"uhcp_aug_hb_killedZombie"},"color":"light_purple"},{"text":"/5]","color":"gray"}]
...
execute as @s run tellraw @s[tag=!UHCP_Skeleton,advancements={uhcp:augments/hunters_blessing/killed_skeleton=true}] [{"text":"Skeletons ","color":"dark_red","bold":true},{"text":"Slain","color":"gray"},{"text":": [","color":"gray"},{"score":{"name":"@s","objective":"uhcp_aug_hb_killedSkeleton"},"color":"light_purple"},{"text":"/5]","color":"gray"}]
...
execute as @s run tellraw @s[tag=!UHCP_Spider,advancements={uhcp:augments/hunters_blessing/killed_spider=true}] [{"text":"Spiders ","color":"dark_red","bold":true},{"text":"Slain","color":"gray"},{"text":": [","color":"gray"},{"score":{"name":"@s","objective":"uhcp_aug_hb_killedSpider"},"color":"light_purple"},{"text":"/5]","color":"gray"}]
