...
execute at @e[tag=UHCP_New,sort=nearest,limit=1] positioned ~ ~0.6 ~ run function uhcp:augments/effects/prismatic/radiantrelics/voltrune/particles
execute at @e[tag=UHCP_New,sort=nearest,limit=1] positioned ~ ~0.6 ~ rotated ~90 ~ run function uhcp:augments/effects/prismatic/radiantrelics/voltrune/particles
execute at @e[tag=UHCP_New,sort=nearest,limit=1] positioned ~ ~0.6 ~ rotated ~180 ~ run function uhcp:augments/effects/prismatic/radiantrelics/voltrune/particles
execute at @e[tag=UHCP_New,sort=nearest,limit=1] positioned ~ ~0.6 ~ rotated ~270 ~ run function uhcp:augments/effects/prismatic/radiantrelics/voltrune/particles
