...
execute if score %diff uhcp_aug_count matches 0 run playsound minecraft:item.shield.block master @a[distance=..4] ~ ~ ~ 1 1 0.75
execute if score %diff uhcp_aug_count matches 1.. run playsound minecraft:entity.panda.hurt master @a[distance=..4] ~ ~ ~ 1 1 0.75
