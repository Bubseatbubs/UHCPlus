...
# Reroll Panes
execute unless entity @s[tag=UHCP_AugmentRerollSlot1] run item replace entity @s inventory.21 with lime_stained_glass_pane[minecraft:custom_data={uhcp_reroll:1b,uhcp_reroll_slot:1b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}']] 1
execute unless entity @s[tag=UHCP_AugmentRerollSlot2] run item replace entity @s inventory.22 with lime_stained_glass_pane[minecraft:custom_data={uhcp_reroll:1b,uhcp_reroll_slot:2b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}']] 1
execute unless entity @s[tag=UHCP_AugmentRerollSlot3] run item replace entity @s inventory.23 with lime_stained_glass_pane[minecraft:custom_data={uhcp_reroll:1b,uhcp_reroll_slot:3b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}']] 1
