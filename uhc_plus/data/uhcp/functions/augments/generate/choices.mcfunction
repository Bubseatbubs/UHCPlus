...
execute unless score @s uhcp_a_patron matches 8 store result score %augment_reroll uhcp_itemInv run function uhcp:augments/roll/3
execute if score @s uhcp_a_patron matches 8 store result score %augment_reroll uhcp_itemInv run function uhcp:augments/roll/4
