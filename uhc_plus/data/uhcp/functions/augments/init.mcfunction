...
# Extra fluff
execute if score %tier uhcp_a_tier matches 0 run title @s subtitle [{"text":"Augment Tier:","color":"#CCFCFF"},{"text":" Silver","color":"#B0B1D6","bold":true}]
execute if score %tier uhcp_a_tier matches 1 run title @s subtitle [{"text":"Augment Tier:","color":"#CCFCFF"},{"text":" Gold","color":"gold","bold":true}]
execute if score %tier uhcp_a_tier matches 2 run title @s subtitle [{"text":"Augment Tier:","color":"#CCFCFF"},{"text":" Pr","color":"#22CAD6","bold":true},{"text":"is","color":"#59FFE9"},{"text":"ma","color":"#99FAED"},{"text":"tic","color":"#D4FAEB"}]
