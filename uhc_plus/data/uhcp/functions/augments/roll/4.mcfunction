...
data modify storage uhcp:augments Roll append from entity @s Inventory[{Slot:7b}].components."minecraft:custom_data".augment
...
execute store success score %augment_duplicate uhcp_itemCount run data modify storage uhcp:augments Roll[3] set from storage uhcp:augments Roll[0]
execute if score %augment_duplicate uhcp_itemCount matches 0 run return 1
...
execute if score %augment_duplicate uhcp_itemCount matches 0 run return 1
execute store success score %augment_duplicate uhcp_itemCount run data modify storage uhcp:augments Roll[0] set from storage uhcp:augments Roll[4]
execute if score %augment_duplicate uhcp_itemCount matches 0 run return 1
execute store success score %augment_duplicate uhcp_itemCount run data modify storage uhcp:augments Roll[1] set from storage uhcp:augments Roll[5]
execute if score %augment_duplicate uhcp_itemCount matches 0 run return 1
execute store success score %augment_duplicate uhcp_itemCount run data modify storage uhcp:augments Roll[5] set from storage uhcp:augments Roll[4]
execute if score %augment_duplicate uhcp_itemCount matches 0 run return 1
