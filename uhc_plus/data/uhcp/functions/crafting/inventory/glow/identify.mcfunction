...
execute store success score %uhcp_itemB uhcp_itemInv run data modify storage uhcp:craft InventoryWork[-1].components."minecraft:custom_data".uhcp_sight set value 1b
