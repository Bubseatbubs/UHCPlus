...
data modify storage minecraft:uhcp_craft InventoryWork set from storage minecraft:uhcp_craft Inventory
execute store result score %uhcp_itemSlot uhcp_itemInv run data get storage minecraft:uhcp_craft Inventory
scoreboard players set %uhcp_item uhcp_itemCount 0
scoreboard players set %uhcp_itemArrC uhcp_itemInv 0
execute if score %uhcp_itemSlot uhcp_itemInv matches 1.. run function uhcp:crafting/inventory/glow/search
