...
execute store success score %uhcp_itemB0 uhcp_itemInv run data modify storage minecraft:uhcp_craft InventoryWork[0].tag.uhcp_player set value 1b
execute if score %uhcp_itemB0 uhcp_itemInv matches 0 run scoreboard players set %uhcp_itemB uhcp_itemInv 0
execute store success score %uhcp_itemB0 uhcp_itemInv run data modify storage minecraft:uhcp_craft InventoryWork[0].tag.LodestoneTracked set value 1b
execute if score %uhcp_itemB0 uhcp_itemInv matches 0 run scoreboard players set %uhcp_itemB uhcp_itemInv 0
