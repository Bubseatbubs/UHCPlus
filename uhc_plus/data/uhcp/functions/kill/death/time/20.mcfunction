...
execute in minecraft:overworld positioned 0 0 0 if entity @a[tag=UHCP_RespawnCheck,distance=..42426385] run tag @s remove UHCP_Died
execute in minecraft:the_end positioned 0 0 0 if entity @a[tag=UHCP_RespawnCheck,distance=..42426385] run tag @s remove UHCP_Died
