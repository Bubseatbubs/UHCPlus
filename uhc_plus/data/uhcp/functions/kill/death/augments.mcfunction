execute if score @s uhcp_augment matches 208 run attribute @s minecraft:generic.armor modifier remove 05e629b8-3a86-4491-bd8e-9c6584dd335c
execute if score @s uhcp_augment matches 237 run scoreboard players set @s uhcp_aug_gloryOfRa -10
execute if score @s[tag=UHCP_Explode] uhcp_augment matches 210 run summon minecraft:creeper ~ ~ ~ {Fuse:0,powered:1}
execute if score @s uhcp_augment matches 147 run setblock ~ ~ ~ warped_fungus
