# AFK
execute if score @s uhcp_augment matches 101 run return run execute if score %time uhcp_game_time matches ..3599 run function uhcp:milk_bucket/apply/augments/silver/afk
