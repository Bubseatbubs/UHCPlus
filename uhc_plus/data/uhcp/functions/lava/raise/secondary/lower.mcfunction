...
# Reset timer
execute unless score %lava uhcp_lavaTime matches 1.. run scoreboard players set %uhcp_lavaSec uhcp_lavaTime 20
execute if score %lava uhcp_lavaTime matches 1.. run scoreboard players set %uhcp_lavaSec uhcp_lavaTime 70
execute if score %lava uhcp_lavaCurrentHeight matches 319.. run scoreboard players set %uhcp_lavaSec uhcp_lavaTime 20
