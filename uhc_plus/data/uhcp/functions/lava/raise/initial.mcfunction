...
execute if score %lava uhcp_lava_currentHeight matches -63..0 run function uhcp:lava/replace/initial/branches/1
execute if score %lava uhcp_lava_currentHeight matches 1..64 run function uhcp:lava/replace/initial/branches/2
execute if score %lava uhcp_lava_currentHeight matches 65..128 run function uhcp:lava/replace/initial/branches/3
execute if score %lava uhcp_lava_currentHeight matches 129..192 run function uhcp:lava/replace/initial/branches/4
execute if score %lava uhcp_lava_currentHeight matches 193..256 run function uhcp:lava/replace/initial/branches/5
