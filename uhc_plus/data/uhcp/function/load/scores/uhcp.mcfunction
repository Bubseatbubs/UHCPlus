# Augment tier
execute unless score %random uhcp_aug_tier = %random uhcp_aug_tier run scoreboard players operation %random uhcp_aug_tier = %random_def uhcp_settings
execute unless score %tier uhcp_aug_tier = %tier uhcp_aug_tier if score %random uhcp_aug_tier matches 0 run scoreboard players operation %tier uhcp_aug_tier = %tier_def uhcp_settings
...
execute unless score %enchant_reduce uhcp_settings = %enchant_reduce uhcp_settings run scoreboard players operation %enchant_reduce uhcp_settings = %enchant_reduce_def uhcp_settings
