...
# Cobweb limit
execute unless score %cobweb_limit uhcp_settings = %cobweb_limit uhcp_settings run scoreboard players operation %cobweb_limit uhcp_settings = %cobweb_limit_def ssiege_settings
