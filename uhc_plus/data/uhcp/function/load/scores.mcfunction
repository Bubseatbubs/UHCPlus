...
execute unless score %tier uhcp_aug_tier = %tier uhcp_aug_tier if score %random uhcp_aug_tier matches 0 run scoreboard players operation %tier uhcp_aug_tier = %tier_def uhcp_aug_tier
