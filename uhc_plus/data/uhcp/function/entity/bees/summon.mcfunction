...
execute anchored eyes run summon minecraft:bee ~ ~2 ~ {CanPickUpLoot:0b,AngerTime:1000,Health:1f,HasNectar:0b,HasStung:0b,Tags:["UHCP_Summon","UHCP_Bee","UHCP_New"],attributes:[{id:"minecraft:attack_damage",base:4.0d}]}
