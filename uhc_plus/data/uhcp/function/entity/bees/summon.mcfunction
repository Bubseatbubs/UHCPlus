...
execute anchored eyes positioned ~ ~ ~ run summon minecraft:bee ~ ~2 ~ {AngerTime:1000,Health:1f,HasNectar:0b,HasStung:0b,Tags:["UHCP_Summon","UHCP_Bee","UHCP_New"],attributes:[{id:"minecraft:generic.attack_damage",base:4.0d}]}
