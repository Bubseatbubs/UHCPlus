...
execute if items entity @s hotbar.* minecraft:fishing_rod[!minecraft:custom_data~{uhcp_cat_lady:false}] run function uhcp:augments/effects/silver/crazycatlady/fishing_rod/unmark_hotbar

execute unless items entity @s inventory.* minecraft:fishing_rod[!minecraft:custom_data~{uhcp_cat_lady:false}] run return run function uhcp:augments/effects/silver/crazycatlady/fishing_rod/unmark_end
...
function uhcp:augments/effects/silver/crazycatlady/fishing_rod/unmark_end
