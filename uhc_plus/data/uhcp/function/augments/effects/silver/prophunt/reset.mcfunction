...
execute if score %mode uhcp_settings matches 0 run effect give @s minecraft:resistance 1 5
execute if score %mode uhcp_settings matches 1 run effect give @s minecraft:resistance 3 0
