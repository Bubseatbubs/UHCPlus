...
execute in uhcp:main run loot replace block 0 0 0 container.0 mine 8 -10 8 minecraft:netherite_pickaxe[minecraft:enchantments={levels:{"minecraft:silk_touch":1}}]
