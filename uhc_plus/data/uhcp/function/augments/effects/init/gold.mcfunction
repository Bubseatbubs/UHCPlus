# Gold augments
execute if score @s uhcp_augment matches 0 run return fail
...
execute if score @s uhcp_augment matches 3 run return fail
...
execute if score @s uhcp_augment matches 10 run return fail
...
execute if score @s uhcp_augment matches 16 run return fail
...
execute if score @s uhcp_augment matches 28 run return fail
execute if score @s uhcp_augment matches 29 run return run function uhcp:augments/effects/gold/starterkitii
execute if score @s uhcp_augment matches 30 run return fail
...
execute if score @s uhcp_augment matches 42 run return fail
execute if score @s uhcp_augment matches 43 run return run function uhcp:augments/effects/gold/mansbestfriend
execute if score @s uhcp_augment matches 44 run return fail
