...
execute if score @s uhcp_augment matches 232 run return run loot give @s loot uhcp:consumables/suspicious_bamboo_sugar
execute if score @s uhcp_augment matches 233 run return run loot give @s loot uhcp:augments/perfect_replica
execute if score @s uhcp_augment matches 234 run return run loot give @s loot uhcp:augments/bookwormii
...
execute if score @s uhcp_augment matches 246 run loot give @s loot uhcp:augments/buzzy_bees
