...
# Calculate additional apples
scoreboard players operation @s uhcp_aug_time = %time uhcp_game_time
scoreboard players operation @s uhcp_aug_time /= #2400 uhcp_const
scoreboard players operation @s uhcp_game_time /= #2400 uhcp_const
...
function uhcp:augments/effects/gold/johnnyappleseed/additional with storage uhcp:augments DripEcon
scoreboard players reset @s uhcp_leave
