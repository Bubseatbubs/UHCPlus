...
summon minecraft:sniffer ~ ~ ~ {PersistenceRequired:1b,Invulnerable:1b,Tags:["UHCP_Sniffa","UHCP_Summon","UHCP_InitScore","UHCP_Invulnerable"],attributes:[{id:"minecraft:scale",base:0.5d}],CustomName:'{"text":"SNIFFA","color":"gold","bold":true,"underlined":true}'}
