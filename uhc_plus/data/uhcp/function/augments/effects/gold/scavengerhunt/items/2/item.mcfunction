...
# Second half
execute if score @s uhcp_aug_sh_item2 matches 10 run return run execute if predicate uhcp:augments/scavenger_hunt/horse_armor run function uhcp:augments/effects/gold/scavengerhunt/items/2/horse_armor
