...
# Second half
execute if score @s uhcp_aug_sh_item6 matches 10 run return run execute if predicate uhcp:augments/scavenger_hunt/iron_horse_armor run function uhcp:augments/effects/gold/scavengerhunt/items/6/iron_horse_armor
