...
execute as @s[tag=UHCP_DisableArmorAndOffhand] run function uhcp:augments/effects/prismatic/cyberneticdownload/get_current_attributes_armor_stand
tag @s[tag=UHCP_DisableArmorAndOffhand] add UHCP_CDDisableArmor
execute as @s[tag=UHCP_DisableArmorAndOffhand] run function uhcp:entity/armor/load_armor

execute as @s[tag=!UHCP_CDDisableArmor] run function uhcp:augments/effects/prismatic/cyberneticdownload/get_current_attributes
...
execute as @s[tag=UHCP_CDDisableArmor] run function uhcp:entity/armor/store_armor
tag @s[tag=UHCP_CDDisableArmor] remove UHCP_CDDisableArmor
