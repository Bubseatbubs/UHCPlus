...
execute store result storage uhcp:augments HedgeFund.amount int 1 run scoreboard players get %gold uhcp_aug_count
function uhcp:augments/effects/prismatic/hedgefund/give with storage uhcp:augments HedgeFund
