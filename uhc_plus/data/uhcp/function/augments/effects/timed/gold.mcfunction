...
execute at @s[scores={uhcp_augment=43}] run return run function uhcp:augments/effects/gold/mansbestfriend/identify
execute at @s[scores={uhcp_augment=49}] run return run function uhcp:augments/effects/gold/fossilfuel/init
