...
item replace entity @s[tag=!UHCP_Spectator] inventory.21 with minecraft:lime_stained_glass_pane[minecraft:custom_data={uhcp_augmentselect:1b,uhcp_reroll:1b,uhcp_reroll_slot:1b,uhcp_glass:1b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',minecraft:lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}'],minecraft:max_stack_size=1] 1
item replace entity @s[tag=!UHCP_Spectator] inventory.22 with minecraft:lime_stained_glass_pane[minecraft:custom_data={uhcp_augmentselect:1b,uhcp_reroll:1b,uhcp_reroll_slot:2b,uhcp_glass:1b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',minecraft:lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}'],minecraft:max_stack_size=1] 1
item replace entity @s[tag=!UHCP_Spectator] inventory.23 with minecraft:lime_stained_glass_pane[minecraft:custom_data={uhcp_augmentselect:1b,uhcp_reroll:1b,uhcp_reroll_slot:3b,uhcp_glass:1b},minecraft:item_name='{"text":"Reroll Augment Choice","color":"gold"}',minecraft:lore=['{"color":"gray","text":"Select this option to reroll the Augment"}','{"color":"gray","text":"below. You can only reroll a slot once."}'],minecraft:max_stack_size=1] 1
