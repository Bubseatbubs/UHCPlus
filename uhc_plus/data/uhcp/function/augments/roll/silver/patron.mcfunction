...
execute unless score %patrons uhcp_settings matches 1 run return run item replace entity @s container.3 with minecraft:black_stained_glass_pane[minecraft:custom_data={uhcp_augmentselect:1b,uhcp_panes:1b,uhcp_glass:1b},minecraft:item_name='{"text":"Select an Augment!","color":"gold"}',minecraft:hide_tooltip={},minecraft:max_stack_size=1] 1
