...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^31 ^33 ^9 minecraft:mangrove_button[powered=true] run return run scoreboard players set %lobby_item_3 uhcp_initStatus 0
