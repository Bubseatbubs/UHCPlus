...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^29 ^25 ^33 minecraft:polished_blackstone_button[powered=true] run return run scoreboard players set %lobby_item_8 uhcp_initStatus 0
