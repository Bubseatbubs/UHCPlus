...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^31 ^25 ^32 minecraft:bamboo_button[powered=true] run return run scoreboard players set %lobby_item_4 uhcp_initStatus 0
