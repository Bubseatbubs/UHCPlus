...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^34 ^11 ^29 minecraft:bamboo_button[powered=true] run return run scoreboard players set %lobby_item_2 uhcp_initStatus 0
