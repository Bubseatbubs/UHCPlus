...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^9 ^26 ^46 minecraft:bamboo_button[powered=true] run return run scoreboard players set %lobby_item_0 uhcp_initStatus 0
