...
execute at @e[tag=UHCP_LobbyOrigin] unless block ^14 ^17 ^18 minecraft:polished_blackstone_button[powered=true] run return run scoreboard players set %lobby_firework uhcp_initStatus 0
