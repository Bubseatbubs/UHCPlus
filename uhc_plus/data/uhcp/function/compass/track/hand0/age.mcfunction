...
execute store result storage uhcp:compass Compass.hand[0].components."minecraft:custom_data".compass_age byte 1 run scoreboard players get %compass_age uhcp_itemInv
