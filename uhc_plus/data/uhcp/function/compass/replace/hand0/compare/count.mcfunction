# Compare item counts
execute store result score %compass_count_new uhcp_itemInv run data get storage uhcp:compass Compass.hand[0].count
...
execute unless score %compass_count uhcp_itemInv matches 0 run function uhcp:compass/replace/hand0/compare/reassign
