...
execute if score %displayS uhcp_game_time matches 10..59 run return run function uhcp:timer/macro_displaytimer with storage uhcp:displaytime input
function uhcp:timer/macro_displaytimerzero with storage uhcp:displaytime input
