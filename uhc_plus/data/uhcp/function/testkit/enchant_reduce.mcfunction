# Weapons
item replace entity @s container.0 with minecraft:diamond_sword[minecraft:enchantments={"minecraft:sharpness":1}]
item replace entity @s container.2 with minecraft:diamond_axe[minecraft:enchantments={"minecraft:sharpness":1}]
