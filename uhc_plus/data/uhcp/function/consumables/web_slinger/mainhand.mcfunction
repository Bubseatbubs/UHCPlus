...
execute if score @s uhcp_initStatus matches 1 run return run function uhcp:consumables/web_slinger/remove/mainhand
scoreboard players remove @s uhcp_initStatus 1
item modify entity @s weapon.mainhand uhcp:count
function uhcp:consumables/web_slinger/init
