...
execute as @e[type=!minecraft:player,predicate=uhcp:targetable,distance=..9] unless score @s uhcp_team = @p[tag=UHCP_Owner] uhcp_team run data merge entity @s {Motion:[0.0,1.25,0.0]}
