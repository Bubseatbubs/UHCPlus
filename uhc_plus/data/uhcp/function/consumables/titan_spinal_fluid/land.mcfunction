...
execute as @e[type=!#uhcp:inanimate_mobs,distance=..7] at @s unless score @s uhcp_team = @p[tag=UHCP_Owner] uhcp_team run damage @s 8 minecraft:player_attack by @p[tag=UHCP_Owner]
