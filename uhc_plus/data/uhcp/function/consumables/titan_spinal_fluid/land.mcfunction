...
execute as @e[type=!minecraft:player,predicate=uhcp:targetable,distance=..9] unless score @s uhcp_team = @a[tag=UHCP_Owner,sort=nearest,limit=1] uhcp_team run data merge entity @s {Motion:[0.0,1.25,0.0]}
