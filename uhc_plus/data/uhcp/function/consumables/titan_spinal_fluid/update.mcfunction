...
execute if score @s uhcp_transformDuration matches 500 run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 100 1 1
execute if score @s uhcp_transformDuration matches 520 run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 100 1 1
execute if score @s uhcp_transformDuration matches 540 run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 100 1 1
execute if score @s uhcp_transformDuration matches 560 run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 100 1 1
execute if score @s uhcp_transformDuration matches 580 run playsound minecraft:block.note_block.harp master @s ~ ~ ~ 100 1 1
