...
execute if score @s uhcp_timer matches 20 at @s run playsound minecraft:block.note_block.harp master @a[distance=..2] ~ ~ ~ 1 1 1
execute if score @s uhcp_timer matches 40 at @s run playsound minecraft:block.note_block.harp master @a[distance=..2] ~ ~ ~ 1 1 1
execute if score @s uhcp_timer matches 60 at @s run playsound minecraft:block.note_block.harp master @a[distance=..2] ~ ~ ~ 1 1 1
