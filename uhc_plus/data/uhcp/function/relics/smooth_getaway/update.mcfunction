...
execute as @e[tag=UHCP_SClone] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run tp @n[tag=UHCP_CurrentStand] @s
execute as @e[tag=UHCP_Hitbox] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run tp @s @n[tag=UHCP_CurrentStand]
...
execute as @e[tag=UHCP_SClone] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run tp @s 0 -64 0
execute as @e[tag=UHCP_SClone] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run kill @s
execute as @e[tag=UHCP_Hitbox] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run tp @s 0 -64 0
execute as @e[tag=UHCP_Hitbox] if score @s uhcp_id = @n[tag=UHCP_CurrentStand] uhcp_id run kill @s
