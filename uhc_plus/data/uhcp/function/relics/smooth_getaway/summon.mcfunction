...
summon minecraft:wolf ~ ~ ~ {Silent:1b,Health:50f,CustomNameVisible:0b,CustomName:'{"text":"Mirage","color":"yellow","bold":true}',Sitting:0b,Tags:["UHCP_SClone","UHCP_Summon","UHCP_New","UHCP_InitScore"],HandItems:[{id:"minecraft:diamond_axe",components:{"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}},"minecraft:attribute_modifiers":{"modifiers":[{"id":"uhcp:wolf_attack_damage","type":"minecraft:attack_damage","amount":1.0d,"operation":"add_multiplied_base","slot":"mainhand"}]}}},{}],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:attack_damage",base:5.0d},{id:"minecraft:max_health",base:50.0d},{id:"minecraft:scale",base:0.016d}]}
summon minecraft:giant ~ ~ ~ {NoAI:1b,Silent:1b,Health:15f,attributes:[{id:"minecraft:max_health",base:15.0d},{id:"minecraft:scale",base:0.166d}],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],Tags:["UHCP_Hitbox","UHCP_InitScore","UHCP_New"]}
