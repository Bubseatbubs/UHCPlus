...
execute as @e[tag=UHCP_TurretHitbox] if score @s uhcp_id = @n[tag=UHCP_CurrentTurret] uhcp_id run tp @s @n[tag=UHCP_CurrentTurret]
...
execute on passengers if entity @s[tag=UHCP_TurretHead] at @s facing entity @n[tag=UHCP_TurretTarget] eyes run tp @s ~ ~ ~ ~90 0
