...
execute unless entity @e[tag=UHCP_TurretTarget] on passengers at @s[tag=UHCP_TurretHead] run tp @s ~ ~ ~ ~2 0
...
execute on passengers at @s[tag=UHCP_TurretHead] facing entity @n[tag=UHCP_TurretTarget] eyes run tp @s ~ ~ ~ ~90 0
