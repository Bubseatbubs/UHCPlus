...
execute if entity @s[tag=UHCP_PhantomPains] as @e[tag=!UHCP_InflictedWithPhantomPain,predicate=uhcp:targetable,distance=..4] unless score @s uhcp_team = @n[tag=UHCP_Damage] uhcp_team at @s run tag @s add UHCP_InflictedWithPhantomPain
