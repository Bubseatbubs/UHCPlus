...
execute if entity @s[tag=UHCP_ZeusFavor] as @a[gamemode=survival] if score @s uhcp_team = @n[tag=UHCP_CurrentFluxFactor] uhcp_team run effect give @s minecraft:resistance 1 5 true
