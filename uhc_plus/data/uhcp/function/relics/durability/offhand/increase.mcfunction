execute store result score %current_damage uhcp_aug_durability run data get entity @s equipment.offhand.components."minecraft:damage"
...
execute store result score %max_damage uhcp_aug_durability run data get entity @s equipment.offhand.components."minecraft:max_damage"
