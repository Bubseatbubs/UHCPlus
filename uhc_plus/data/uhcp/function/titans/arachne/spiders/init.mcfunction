...
execute at @e[tag=UHCP_SpiderMarker] run summon minecraft:spider ~ ~ ~ {Health:10f,Motion:[0.0,0.8,0.0],CustomNameVisible:0b,PersistenceRequired:1b,Tags:["UHCP_ArachneSpider","UHCP_Minion"],attributes:[{id:"minecraft:generic.max_health",base:20.0d},{id:"minecraft:generic.scale",base:2.0d},{id:"minecraft:generic.knockback_resistance",base:0.0d},{id:"minecraft:generic.attack_damage",base:5.0d},{id:"minecraft:generic.armor",base:1.0d}],Passengers:[{id:"minecraft:zombie",Silent:1b,Invulnerable:1b,Tags:["UHCP_Summon","UHCP_ArachneSpiderAI"],ArmorItems:[{},{},{},{id:"minecraft:oak_button",components:{"minecraft:enchantments":{levels:{"minecraft:vanishing_curse":1}}},count:1}],active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:generic.attack_damage",base:5.0d},{id:"minecraft:generic.scale",base:0.016d}]}]}
