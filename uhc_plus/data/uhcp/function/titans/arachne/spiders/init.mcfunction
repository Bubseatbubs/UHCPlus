...
execute at @e[tag=UHCP_SpiderMarker] run summon minecraft:spider ~ ~ ~ {Health:10f,Motion:[0.0,0.8,0.0],CustomNameVisible:0b,PersistenceRequired:1b,CanPickUpLoot:0b,Tags:["UHCP_ArachneSpider","UHCP_Minion"],attributes:[{id:"minecraft:max_health",base:20.0d},{id:"minecraft:scale",base:2.0d},{id:"minecraft:knockback_resistance",base:0.0d},{id:"minecraft:attack_damage",base:5.0d},{id:"minecraft:armor",base:1.0d}],Passengers:[{id:"minecraft:zombie",Silent:1b,Invulnerable:1b,Tags:["UHCP_Summon","UHCP_ArachneSpiderAI"],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:attack_damage",base:5.0d},{id:"minecraft:scale",base:0.016d}]}]}
