...
execute if score %temp uhcp_initStatus matches 0 run execute store result score %blocksfilled2 uhcp_titans_count run fill ~-6 ~ ~-6 ~6 ~12 ~6 minecraft:air replace #uhcp:titan_can_break
