...
summon minecraft:item ~ ~ ~ {Glowing:1b,PickupDelay:40s,Motion:[0.0,1.0,0.0],Tags:["UHCP_FerrumShield"],Item:{id:"minecraft:stone"}}
...
damage @s 0.00000001 minecraft:generic by @e[tag=UHCP_Ferrum,sort=nearest,limit=1]
