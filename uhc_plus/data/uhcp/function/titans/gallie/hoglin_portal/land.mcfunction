...
fill ~-6 ~-2 ~-8 ~6 ~ ~8 minecraft:polished_blackstone_bricks replace #uhcp:visible_breakable
fill ~-8 ~-2 ~-6 ~8 ~ ~6 minecraft:polished_blackstone_bricks replace #uhcp:visible_breakable
