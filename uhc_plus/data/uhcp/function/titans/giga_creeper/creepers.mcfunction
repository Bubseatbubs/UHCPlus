...
execute at @e[tag=UHCP_CreeperMarker] run summon minecraft:creeper ~ ~ ~ {Health:16f,ExplosionRadius:2b,attributes:[{id:"minecraft:max_health",base:24.0d},{id:"minecraft:movement_speed",base:0.35d}]}
