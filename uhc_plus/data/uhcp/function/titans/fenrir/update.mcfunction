...
fill ~-4 ~1 ~-4 ~4 ~6 ~4 minecraft:air replace #uhcp:containers destroy
...
execute if score %temp uhcp_initStatus matches 0 run execute store result score %blocksfilled2 uhcp_titans_count run fill ~-4 ~ ~-4 ~4 ~6 ~4 minecraft:air replace #uhcp:titan_can_break
