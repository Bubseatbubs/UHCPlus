...
# ------------
# ------------ UHC Plus commands
execute unless entity @a[tag=WorldGen] in minecraft:overworld run gamerule doMobSpawning false
execute unless entity @a[tag=WorldGen] in minecraft:the_end run gamerule doMobSpawning false
execute unless entity @a[tag=WorldGen] in minecraft:the_nether run gamerule doMobSpawning false
