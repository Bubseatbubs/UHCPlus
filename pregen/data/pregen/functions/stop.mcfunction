...
#Return to Spawn
# ------------ Commands moved from end to start
#gamemode creative @s
...
# ------------
# ------------ UHC Plus commands
execute unless entity @a[tag=WorldGen] if predicate uhcp:dimensions/minecraft/overworld in minecraft:overworld run gamerule doMobSpawning false
execute unless entity @a[tag=WorldGen] if predicate uhcp:dimensions/minecraft/the_end in minecraft:the_end run gamerule doMobSpawning false
execute unless entity @a[tag=WorldGen] if predicate uhcp:dimensions/minecraft/the_nether in minecraft:the_nether run gamerule doMobSpawning false
