...
execute at @s store result block 0 255 0 exit_portal[0] int 1 run scoreboard players get StartX WorldPregen
execute at @s store result block 0 255 0 exit_portal[2] int 1 run scoreboard players get StartZ WorldPregen
gamemode creative @s
